...
Abbiamo rilasciato la versione 2.19 del [Security Plugin for SonarQube] (sonarqube-security) che consente di visualizzare i CWE non supportati
e di passare come drill-down per ulteriori informazioni.
...
Inoltre, abbiamo aggiunto la possibilità di attivare/disattivare il CWE non superato nel rapporto ISO5055 PDF.
...
<br>
<img src="/img/sonarqube-security/2024-01-09-new-email-version.png" alt="New Security Plugin Email version" width="100%">

## Informazioni su ISO5055
### Cosa possono fare gli standard per voi?

Gli standard internazionali garantiscono che i prodotti e i servizi che utilizzate ogni giorno siano sicuri, affidabili e di alta qualità.

Per maggiori informazioni, visitate il sito web ufficiale [ISO5055](https://www.iso.org/standard/80623.html)

---
layout: post_es
title: Cómo generar informes de calidad del código en SonarQube™ con plugins de bitegarden
description: Descubre cómo obtener una visión completa del estado actual de tus proyectos SonarQube™ con informes de calidad y métricas clave.

permalink: plugins-generar-informes-calidad-codigo-sonarqube
english: plugins-generating-code-quality-reports-sonarqube

cover: /img/posts/2026-06-29-plugins-generating-code-quality-reports-sonarqube_es.png
---
...
<h2>Report for SonarQube™ Server: genera informes completos de calidad del código</h2>
...
- Métricas generales del proyecto. <br>

- Problemas encontrados durante el análisis. <br>

- Estado de calidad del software. <br>

- Información del Quality Gate. <br>

- Datos de mantenibilidad, fiabilidad y seguridad. <br>
...
Si no conocías este plugin, puedes probarlo en tu instancia a través de la descarga desde el [Marketplace de bitegarden](https://marketplace.bitegarden.com/product/bitegardenReport). 


<h2>Rating Report Plugin: una valoración sencilla de la calidad del software</h2>
...
- Comparar diferentes proyectos. <br>

- Identificar rápidamente áreas de mejora. <br>

- Crear informes ejecutivos. <br>

- Comunicar el estado de calidad a perfiles no técnicos. <br>

A través de [este enlace puedes](https://marketplace.bitegarden.com/product/bitegardenRatingReport) probarlo en tu instancia. 

<h2>Overview for SonarQube™ Server: una visión global de todos tus proyectos</h2>
...
- ¿Qué proyectos tienen peor calidad actualmente? <br>

- ¿Dónde existe mayor deuda técnica? <br>

- ¿Qué equipos necesitan priorizar mejoras? <br>

- ¿Cómo evoluciona la calidad del código? <br>

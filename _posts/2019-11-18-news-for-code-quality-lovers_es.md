...
description: SQALE plugin for SonarQube&trade;  tiene nuevas funcionalidades para gestionar la deuda técnica. También hemos añadido dos nuevos plugins para sonar a nuestro portfolio - Project Tag y Rating Report incorporan funcionalidades avanzadas en el uso de etiquetas de SonarQube&trade;
...
### Presentación de Project Tag Plugin for SonarQube&trade;
...
### Una introducción a Rating Report Plugin for SonarQube&trade;

SonarQube&trade; tiene un poderoso modelo de calidad basado en fiabilidad, seguridad y mantenibilidad. Pero a veces se necesita saber un poco más ... ¿Qué pasa con el rendimiento? ¿Y con el manejo de errores? ¿La experiencia de usuario?

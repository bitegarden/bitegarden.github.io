---
layout: post_es
title: Security Assessment for SonarQube Server 2.35
description: Añadimos el informe de seguridad CASA y su descarga en PDF para los modos estándar y MQR.

permalink: version-security-assessment-sonarqube-server-2-35
english: release-security-assessment-sonarqube-server-2-35

cover: /img/posts/2026-08-14-release-security-assessment-sonarqube-server-2-35_es.png
...
Si ya eres usuario del [Universal Plugin Manager](https://marketplace.bitegarden.com/product/bitegardenUniversalPluginManager), simplemente accede a la administración de plugins y pulsa sobre el botón de actualización disponible.

Si aún no has probado **bitegarden Security Assessment for SonarQube&trade; Server**, puedes descargarlo e instalarlo en tu instancia a través de [este enlace](https://marketplace.bitegarden.com/product/bitegardenSecurity). 

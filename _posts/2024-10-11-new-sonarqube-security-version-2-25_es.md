...
<img src="/img/sonarqube-security/security-plugin-sonarqube-2-25_breakdown.png" alt="New cwe report breakdown" width="100%" />
<br/>
<br/>
...
Security Plugin para SonarQube 2.25 ya está disponible para descarga a través del [Universal Plugin Manager](/es/sonarqube-upm)  o desde la página de [descarga del producto](https://marketplace.bitegarden.com/download/download-form/52).

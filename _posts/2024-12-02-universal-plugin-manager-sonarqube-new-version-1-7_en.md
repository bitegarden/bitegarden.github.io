...
In this **version 2.43**, the bitegarden development team has added a new functionality. This is a **new section called 'Marketplace'** in which you can search for third-party plugins. When you click on that section you can search for products through a list that will appear or you can find them thanks to a **new search bar**. 
...
In this image you can see how it is from **version 2.43**. 
<br>

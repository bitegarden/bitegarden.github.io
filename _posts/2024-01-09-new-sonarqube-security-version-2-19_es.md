---
layout: post_es
title: Nueva versión del Security Plugin for SonarQube!
...
Lanzamos la versión 2.19 del [Security Plugin for SonarQube](sonarqube-security). Esta actualiza trae consigo una nueva funcionalidad que permite mostrar los **CWE no soportados y pasados** como desglose, para darte más información sobre el estado de tu código.
...
Los **estándares internacionales** garantizan que los productos y servicios que utiliza a diario son seguros, fiables y de alta calidad.

Si desea más información, puedes visitar la página oficial [ISO 5055](https://www.iso.org/standard/80623.html)
...
Si todavía no has probado este plugin, recuerda que puedes hacerlo de **forma gratuita**. 

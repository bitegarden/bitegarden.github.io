---
layout: post
title: SonarQube&trade; Plugins - Our motivation and goals
description: Why do we develop SonarQube&trade; plugins? How did we start this code quality project? Discover all the benefits of extending sonar functionalities as well as the reasons behind bitegarden and two of our most successful SonarQube&trade; plugins.
...
**bitegarden** was born more than a year ago as a side project of a group of SonarQube&trade; professionals. We wanted to 
spread our knowledge and help with our experience as highly trained and specialised SonarQube&trade; consultants.  When we 
look back, it's hard to believe what we've achieved after a year. 

## SonarQube&trade; power

We love SonarQube&trade; and we believe it's the best tool to write clean and secure code out there. But in this industry, 
and specially in an open source product like SonarQube&trade; there is always room for personalisation and added features.

Years working with SonarQube&trade; and collaborating in forums, events and communities, have resulted in an extensive knowledge 
...
But at the same time, **we observed how development teams taking the most out of SonarQube&trade; improved the quality of 
their software day by day. We've seen the impact that SonarQube&trade; have on developing better and safer code.** 
We love their approach and we completely share it: sonar is a developer centered tool, which helps developers develop 
better software.

But the software development lifecycle involves other roles too, not only developers. We want to give SonarQube&trade; all the
reporting features that are missing and are asked for by project managers, product owners and as much people as we can. 
And that's basically what we do: **we create plugins for SonarQube&trade; tailored to the needs of each specific team.**

## SonarQube&trade; plugins

Two great examples of the motivation behind bitegarden are SQALE and Overview Report plugins. 

\- [SQALE plugin for SonarQube&trade;](https://www.bitegarden.com/sonarqube-sqale) brings back a software quality model that 
used to be present on SonarQube&trade; previous versions. 
The SQALE method is focused on Technical Debt management and it's compliant to ISO 25000, so not only our plugin fits 
the needs of those who are missing SQALE on SonarQube&trade;, but of those who are looking for a specific, certified and 
...
**The final goal is to put bitegarden as a referent in the SonarQube&trade; ecosystem allowing more teams to grow using this 
incredible code quality tool. We want to be the primary plugin directory for SonarQube&trade; and become a 

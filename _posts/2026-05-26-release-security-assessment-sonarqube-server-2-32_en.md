---
layout: post
title: ¡New version! Security Assessment for SonarQube Server 2.32
description: We added support for the CWE Top 10 KEV Weaknesses security standard analysis, as well as PDF export functionality. 

permalink: release-security-assessment-sonarqube-server-2-32
spanish: version-security-assessment-sonarqube-server-2-32

cover: /img/posts/2026-05-26-release-security-assessment-sonarqube-server-2-32_en.png
---
...
If you are already using the plugin, you can access the [Universal Plugin Manager for SonarQube&trade; Server (UPM)](https://marketplace.bitegarden.com/product/bitegardenUniversalPluginManager) and click update. If you have not tried it yet, you can download the plugin and test it in your instance here: [bitegarden Security Assessment for SonarQube&trade; Server](https://marketplace.bitegarden.com/product/bitegardenSecurity), and configure it in your instance quickly.
